...
def test_policy_config_from_state_rebuilds_from_fields():
    with patch('logstashagent.agent_state.get_state', return_value={
        'mode': 'simulate',
        'instance_id': 4,
        'settings_path': '/opt/LogstashAgent/simulate-4/settings',
        'config_path': '/opt/LogstashAgent/simulate-4/config',
        'logs_path': '/opt/LogstashAgent/simulate-4/logs',
        'data_path': '/opt/LogstashAgent/simulate-4/data',
        'binary_path': '/usr/share/logstash/bin',
        'keystore_env_file': '/opt/LogstashAgent/simulate-4/env',
        'agent_api_port': 9504,
